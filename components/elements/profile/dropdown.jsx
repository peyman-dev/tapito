...
import LogoutModal from "@/components/elements/modals/logout";
    ...
    return (
        <DropdownMenu open={isOpen} dir="rtl" onOpenChange={setIsOpen}>
            ...
            >
                ...
                <DropdownMenuSeparator/>
                <DropdownMenuItem onClick={openLogoutModal} className=" text-red-600 p-1">
...
export default withMemorize(ProfileDropdown)